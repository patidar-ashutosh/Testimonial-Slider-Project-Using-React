...
const Testimonials = (props) => {
    ...
    return (
        <div className='w-[85vw] md:w-[700px] bg-white shadow-md flex flex-col justify-center items-center
        mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md'>
            ...
            <div>
                ...
                className='mt-5 bg-violet-400 hover:bg-violet-500 shadow-md hover:shadow
